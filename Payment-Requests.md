...
* BIP21 and BIP72 formatted payment request URIs are stored in an URI record and work exactly like in the scan-to-pay usecase.
...
* BIP21 and BIP72 formatted payment request URIs that work exactly like in the scan-to-pay usecase.
...
Generally click-to-pay works only if your web browser has whitelisted the "bitcoin" scheme.
...
* BIP21 and BIP72 formatted payment request URI in the data field (again see scan-to-pay). You'll get a success code and optionally a transaction hash returned in the result.
